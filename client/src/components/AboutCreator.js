      ...
      <Row className="about-creator-content">
        <Col sm={12} md={{ span: 5, offset: 1 }}>
          ...
          <h5 className="about-creator-text">
            ...
            to help others! I love learning about new tech and improving my
            craft whenever I get the chance!
          </h5>
          <h5 className="about-creator-text">
          ...
          <h5 className="about-creator-text">Important Info:</h5>
          <h6 className="about-creator-text">Favorite Language: JavaScript</h6>
          ...
          <a
            ...
            target="_blank"
            href="https://maxmanayan.netlify.app/"
          >
